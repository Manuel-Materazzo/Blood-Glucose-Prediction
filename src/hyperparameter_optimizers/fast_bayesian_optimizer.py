...
class FastBayesianOptimizer(HyperparameterOptimizer):
    ...
    def tune(self, X: DataFrame, y: Series, final_lr: float) -> dict:
        ...
        print("WARNING: fast optimizers use classic validation, this may result in unrepresentative MAE scores")
    ...
    def __objective(self, space):
        ...
        mae, _ = self.trainer.classic_validation(self.X, self.y, log_level=0, **params)
